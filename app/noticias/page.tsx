  ...
  return (
    <>
      ...
      <section
        ...
        style={{ backgroundImage: "linear-gradient(var(--photo-tint),var(--photo-tint)), url(/assets/foto-musicos2.webp)", ["--band-m" as string]: "url(/assets/foto-musicos2-m.webp)", backgroundPosition: "center 55%" }}
      >

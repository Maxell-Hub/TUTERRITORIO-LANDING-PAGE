...
export default function ParticipaPage() {
  ...
  return (
    <>
      ...
      <link rel="preload" as="image" href="/assets/transparencia/foto-socializacion2.webp" media="(min-width: 721px)" fetchPriority="high" />
      <link rel="preload" as="image" href="/assets/transparencia/foto-socializacion2-m.webp" media="(max-width: 720px)" fetchPriority="high" />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumb) }} />

      {/* 1 · Hero fotográfico */}
      <section
        className="atg-hero"
        style={{ backgroundImage: "linear-gradient(var(--photo-tint),var(--photo-tint)), url(/assets/transparencia/foto-socializacion2.webp)", ["--hero-m" as string]: "url(/assets/transparencia/foto-socializacion2-m.webp)", backgroundPosition: "center 62%" }}
      >
        <h1>

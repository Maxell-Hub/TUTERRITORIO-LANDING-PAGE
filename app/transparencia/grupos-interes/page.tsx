...
export default function GruposInteresPage() {
  return (
    <TPageATG
      ...
      eyebrow="Sección 6"
      photo="transparencia/foto-valledupar2"
      photoPos="center 48%"
    >
      <Apartado titulo="6.1 Información dirigida a niños, niñas y adolescentes">
      ...
      <Apartado titulo="6.2 Información dirigida a otros grupos de interés">

...
export default function TransparenciaPage() {
  return (
    <>
      ...
      <link rel="preload" as="image" href="/assets/transparencia/foto-alcaldia2.webp" media="(min-width: 721px)" fetchPriority="high" />
      <link rel="preload" as="image" href="/assets/transparencia/foto-alcaldia2-m.webp" media="(max-width: 720px)" fetchPriority="high" />
      <section
        className="atg-hero"

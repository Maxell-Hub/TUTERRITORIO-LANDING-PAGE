...
export default function TransparenciaPage() {
  return (
    <>
      ...
      <link rel="preload" as="image" href="/assets/foto-alcaldia2.webp" media="(min-width: 721px)" fetchPriority="high" />
      <link rel="preload" as="image" href="/assets/foto-alcaldia2-m.webp" media="(max-width: 720px)" fetchPriority="high" />
      <section
        className="atg-hero"
        style={{ backgroundImage: "linear-gradient(var(--photo-tint),var(--photo-tint)), url(/assets/foto-alcaldia2.webp)", ["--hero-m" as string]: "url(/assets/foto-alcaldia2-m.webp)", backgroundPosition: "center 22%" }}
      >
      ...
      <section
        ...
        style={{ backgroundImage: "linear-gradient(var(--photo-tint),var(--photo-tint)), url(/assets/foto-centro2.webp)", ["--band-m" as string]: "url(/assets/foto-centro2-m.webp)", backgroundPosition: "center 45%" }}
      >
        <div className="atg-wrap">

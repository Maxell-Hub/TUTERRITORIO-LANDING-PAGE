...
export default function GlosarioPage() {
  return (
    <>
      ...
      <link rel="preload" as="image" href="/assets/foto-recursos2.webp" media="(min-width: 721px)" fetchPriority="high" />
      <link rel="preload" as="image" href="/assets/foto-recursos2-m.webp" media="(max-width: 720px)" fetchPriority="high" />
      <section className="atg-hero" style={{ backgroundImage: "linear-gradient(var(--photo-tint),var(--photo-tint)), url(/assets/foto-recursos2.webp)", ["--hero-m" as string]: "url(/assets/foto-recursos2-m.webp)", backgroundPosition: "center 40%" }}>
        <h1>ABC Catastral</h1>
      ...
      <section
        ...
        style={{ backgroundImage: "linear-gradient(var(--photo-tint),var(--photo-tint)), url(/assets/foto-pilonera2.webp)", ["--band-m" as string]: "url(/assets/foto-pilonera2-m.webp)", backgroundPosition: "center 37%" }}
      >
        <div className="atg-wrap">

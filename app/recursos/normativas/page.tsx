  ...
  return (
    <>
      ...
      <section
        ...
        style={{ backgroundImage: "linear-gradient(var(--photo-tint),var(--photo-tint)), url(/assets/foto-madres2.webp)", ["--band-m" as string]: "url(/assets/foto-madres2-m.webp)", backgroundPosition: "center 45%" }}
      >
        <div className="atg-wrap">

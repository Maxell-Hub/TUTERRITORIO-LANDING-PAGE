...
export default function NormativasPage() {
  return (
    <>
      ...
      <link rel="preload" as="image" href="/assets/foto-normativas4.jpg" media="(min-width: 721px)" fetchPriority="high" />
      <link rel="preload" as="image" href="/assets/foto-normativas4-m.jpg" media="(max-width: 720px)" fetchPriority="high" />
      <section className="atg-hero" style={{ backgroundImage: "linear-gradient(var(--photo-tint),var(--photo-tint)), url(/assets/foto-normativas4.jpg)", ["--hero-m" as string]: "url(/assets/foto-normativas4-m.jpg)" }}>
        <h1>Normativas</h1>

...
export default function PqrsdPage() {
  return (
    <>
      ...
      <link rel="preload" as="image" href="/assets/pqrsd/foto-radica2.webp" media="(min-width: 721px)" fetchPriority="high" />
      <link rel="preload" as="image" href="/assets/pqrsd/foto-radica2-m.webp" media="(max-width: 720px)" fetchPriority="high" />
      {/* 1 · Hero fotográfico */}
      <section
        className="atg-hero"

...
export const DEFAULT_NORMATIVAS: Norm[] = [
  { id: "norm-101", cat: "Normas generales aplicables", code: "Decreto 1060 de 2025 — Municipio de Valledupar", desc: "Adiciona y modifica el manual específico de funciones y competencias laborales para los empleos de la planta de personal de la administración central del municipio de Valledupar.", href: "#" },
  { id: "norm-102", cat: "Normas generales aplicables", code: "Acuerdo 027 de 2024 — Estatuto Tributario Municipal", desc: "Modifica y actualiza el estatuto tributario del municipio de Valledupar (Acuerdo 022 del 16 de diciembre de 2022).", href: "#" },
  ...
  { id: "norm-105", cat: "Normas generales aplicables", code: "Resolución IGAC 486 de 2021", desc: "Acto administrativo del IGAC mediante el cual se habilitó formalmente al Municipio de Valledupar para asumir la prestación del servicio público de gestión catastral en su jurisdicción.", href: "#" },

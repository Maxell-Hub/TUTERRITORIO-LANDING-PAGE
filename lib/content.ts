...
export const DEFAULT_EQUIPO: Member[] = [
  { id: "eq-lulia-cristina-maestre-arcia", name: "Lulia Cristina Maestre Arcia", role: "Gerente", area: "Dirección", photo: "/assets/equipo/personas/lulia-cristina-maestre-arcia-v3.webp" },

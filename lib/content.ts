...
export const DEFAULT_NOTICIAS: News[] = [
  {
    ...
    imagen: "/assets/noticia-mesas.webp",
    cuerpo:
  ...
  },
  {
    ...
    cuerpo:
      "Los equipos de reconocimiento predial de Tuterritorio comenzaron el levantamiento de información en las comunas 5 y 6 de Valledupar, dando inicio a la actualización catastral 2026. El operativo actualizará linderos, áreas y destino económico de más de 18.000 predios urbanos.\n\nDurante las visitas, el personal de campo — debidamente identificado con carné y chaleco institucional — verifica la información física de cada predio: sus medidas, construcciones, uso y estado. Esta información se contrasta con la base catastral y con la realidad jurídica de cada inmueble para que el catastro refleje fielmente el territorio.\n\nLa actualización catastral es la base de un impuesto predial más justo: predios con información al día pagan según su realidad, y el municipio cuenta con mejores datos para planear obras, servicios e inversión social.\n\nSi tu predio está en las comunas 5 o 6, recibe al equipo de reconocimiento y presenta los documentos de tu inmueble. Cualquier duda puedes resolverla en nuestra sede del Edificio Caja Agraria — Oficina 1301, o a través de los canales de atención de este sitio.",
  },
  {
    id: "n-2026-05-30",
    categoria: "Comunidad",

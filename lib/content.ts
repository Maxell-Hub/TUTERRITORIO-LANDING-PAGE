...
export const DEFAULT_NORMATIVAS: Norm[] = [
  { id: "norm-008", cat: "Normas generales aplicables", code: "Resolución 1149 de 2021 — IGAC", desc: "Adopta las especificaciones técnicas para los productos de la gestión catastral multipropósito.", href: "https://www.igac.gov.co" },
  ...
  { id: "norm-009", cat: "Normas generales aplicables", code: "Resolución 509 de 2020 — IGAC", desc: "Establece las condiciones para la habilitación de los gestores catastrales en el territorio nacional.", href: "https://www.igac.gov.co" },
  { id: "norm-010", cat: "Normas generales aplicables", code: "Resolución 388 de 2020 — IGAC", desc: "Define las especificaciones técnicas para el levantamiento y los productos catastrales.", href: "https://www.igac.gov.co" },
  { id: "norm-011", cat: "Normas generales aplicables", code: "Resolución 471 de 2020 — IGAC", desc: "Fija los estándares y procedimientos para el levantamiento catastral con enfoque multipropósito.", href: "https://www.igac.gov.co" },

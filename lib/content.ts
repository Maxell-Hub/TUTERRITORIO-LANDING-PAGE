...
export const DEFAULT_EQUIPO: Member[] = [
  { id: "ff-23", name: "Lulia Cristina Maestre Arcia", role: "Gerente", area: "Dirección", photo: "/assets/equipo/personas-v2/ff-23.webp" },
  { id: "ff-01", name: "Jorge Hernán Salgado Miranda", role: "Jefe de la Oficina de Gestión Catastral", area: "Dirección", photo: "/assets/equipo/personas-v2/ff-01.webp" },
  { id: "ff-19", name: "Ana Jeraldine Herrera Llerena", role: "Jefe Jurídico", area: "Equipo Tuterritorio", photo: "/assets/equipo/personas-v2/ff-19.webp" },
  { id: "ff-05", name: "Juan David Calderón Márquez", role: "Coordinador Administrativo", area: "Equipo Tuterritorio", photo: "/assets/equipo/personas-v2/ff-05.webp" },
  { id: "ff-11", name: "Liz Paola Muñoz Hernández", role: "Contador", area: "Equipo Tuterritorio", photo: "/assets/equipo/personas-v2/ff-11.webp" },
  { id: "ff-03", name: "Tomas Eduardo Díaz Fontalvo", role: "Contratista", area: "Contratistas", photo: "/assets/equipo/personas-v2/ff-03.webp" },
  { id: "ff-04", name: "Luis Daniel Céspedes Arcia", role: "Contratista", area: "Contratistas", photo: "/assets/equipo/personas-v2/ff-04.webp" },
  { id: "ff-06", name: "Asdrúbal Raúl Vega Salazar", role: "Contratista", area: "Contratistas", photo: "/assets/equipo/personas-v2/ff-06.webp" },
  { id: "ff-07", name: "Albert Emiro Zequeda Ávila", role: "Contratista", area: "Contratistas", photo: "/assets/equipo/personas-v2/ff-07.webp" },
  { id: "ff-08", name: "Iván Camilo Zuleta López", role: "Contratista", area: "Contratistas", photo: "/assets/equipo/personas-v2/ff-08.webp" },
  { id: "ff-09", name: "Eljan Lizeth Cortes Ávila", role: "Contratista", area: "Contratistas", photo: "/assets/equipo/personas-v2/ff-09.webp" },
  { id: "ff-12", name: "Katherin Julieth Duarte Díaz", role: "Contratista", area: "Contratistas", photo: "/assets/equipo/personas-v2/ff-12.webp" },
  { id: "ff-13", name: "Katerine Yulieth Ortega Almendrales", role: "Contratista", area: "Contratistas", photo: "/assets/equipo/personas-v2/ff-13.webp" },
  { id: "ff-14", name: "Zuleima Isabel Terán Bohórquez", role: "Contratista", area: "Contratistas", photo: "/assets/equipo/personas-v2/ff-14.webp" },
  { id: "ff-16", name: "Kelly Johana Martínez Díaz", role: "Contratista", area: "Contratistas", photo: "/assets/equipo/personas-v2/ff-16.webp" },
  { id: "ff-17", name: "María Amparo Camargo Bautista", role: "Contratista", area: "Contratistas", photo: "/assets/equipo/personas-v2/ff-17.webp" },
  { id: "ff-21", name: "Wendy Patricia Amaya Alarza", role: "Contratista", area: "Contratistas", photo: "/assets/equipo/personas-v2/ff-21.webp" },
  { id: "ff-22", name: "Miguel Ángel Bolaño Acosta", role: "Contratista", area: "Contratistas", photo: "/assets/equipo/personas-v2/ff-22.webp" },
  { id: "ff-26", name: "Enrique Jesús Fernández García", role: "Contratista", area: "Contratistas", photo: "/assets/equipo/personas-v2/ff-26.webp" },
  { id: "ff-27", name: "Gina Paola García Pinto", role: "Contratista", area: "Contratistas", photo: "/assets/equipo/personas-v2/ff-27.webp" },
  { id: "ff-29", name: "Luz Ángela Romero Zabaleta", role: "Contratista", area: "Contratistas", photo: "/assets/equipo/personas-v2/ff-29.webp" },
  { id: "ff-30", name: "Arnaldo Mauricio Núñez Ceballo", role: "Contratista", area: "Contratistas", photo: "/assets/equipo/personas-v2/ff-30.webp" },
  { id: "ff-31", name: "Jesús Alberto Vallenilla Castilla", role: "Contratista", area: "Contratistas", photo: "/assets/equipo/personas-v2/ff-31.webp" },
  { id: "ff-33", name: "Wilmer Ortiz Cañate", role: "Contratista", area: "Contratistas", photo: "/assets/equipo/personas-v2/ff-33.webp" },
  { id: "ff-02", name: "Gladys Mercedes Rosado Díaz", role: "Profesional Universitario", area: "Alcaldía", photo: "/assets/equipo/personas-v2/ff-02.webp" },
  { id: "ff-10", name: "Margaret Liliana Muñoz Quintero", role: "Contratista", area: "Alcaldía", photo: "/assets/equipo/personas-v2/ff-10.webp" },
  { id: "ff-15", name: "Iranys Beatriz Ortiz Villalba", role: "Contratista", area: "Alcaldía", photo: "/assets/equipo/personas-v2/ff-15.webp" },
  { id: "ff-18", name: "Valeria Vergara Araujo", role: "Contratista", area: "Alcaldía", photo: "/assets/equipo/personas-v2/ff-18.webp" },
  { id: "ff-20", name: "Margarita Rosa Silva Rojas", role: "Técnico Administrativo", area: "Alcaldía", photo: "/assets/equipo/personas-v2/ff-20.webp" },
  { id: "ff-24", name: "Armando Fontalvo Gamarra", role: "Profesional Universitario", area: "Alcaldía", photo: "/assets/equipo/personas-v2/ff-24.webp" },
  { id: "ff-25", name: "Carlos Alberto Noguera Meza", role: "Profesional Universitario", area: "Alcaldía", photo: "/assets/equipo/personas-v2/ff-25.webp" },
  { id: "ff-28", name: "Luis Eduardo Manjarres Ospino", role: "Contratista", area: "Alcaldía", photo: "/assets/equipo/personas-v2/ff-28.webp" },
  { id: "ff-32", name: "Valentina Amaya Henriquez", role: "Técnico Catastral", area: "Alcaldía", photo: "/assets/equipo/personas-v2/ff-32.webp" },
  { id: "ff-34", name: "Gisella Esther Martínez Gutierrez", role: "Contratista", area: "Alcaldía", photo: "/assets/equipo/personas-v2/ff-34.webp" },
];

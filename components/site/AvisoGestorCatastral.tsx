 ...
 * se radican ante el Gestor Catastral (Alcaldía de Valledupar). Reutilizable en
 * PQRSD y en Trámites y servicios (Decreto 148 de 2020).
 */
...
export default function AvisoGestorCatastral({
  nota,
}: {
  /** Frase de cierre según el contexto de la página. */
  nota?: string;
}) {
  return (
    <aside className="aviso-gestor reveal" role="note" aria-labelledby="aviso-gestor-titulo">
      ...
      <div className="aviso-gestor__body">
        ...
        <p className="aviso-gestor__text">
          ...
          ante el <strong>Gestor Catastral (Alcaldía Municipal de Valledupar)</strong>:
        </p>
        ...
        <div className="aviso-gestor__cta">
          <span className="aviso-gestor__cta-label">Correo oficial del Gestor Catastral:</span>

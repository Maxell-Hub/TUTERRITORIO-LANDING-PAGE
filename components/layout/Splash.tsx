  ...
  return (
    ...
    >
      ...
      <div className="splash-brand">
        ...
        <img className="splash-mark" src="/assets/global/logo-imagotipo-tr.png" alt="Tuterritorio" />
        <span className="splash-word notranslate" translate="no">Tuterritorio</span>
      </div>
